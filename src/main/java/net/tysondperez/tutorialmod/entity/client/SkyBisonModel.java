package net.tysondperez.tutorialmod.entity.client;// Made with Blockbench 4.10.4
...
import net.tysondperez.tutorialmod.entity.animations.ModAnimationDefinitions;
