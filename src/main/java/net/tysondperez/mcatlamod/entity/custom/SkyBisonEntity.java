package net.tysondperez.mcatlamod.entity.custom;
...
import net.tysondperez.mcatlamod.entity.ai.SkyBisonBodyController;
import net.tysondperez.mcatlamod.entity.ai.SkyBisonBreedGoal;
import net.tysondperez.mcatlamod.entity.ai.SkyBisonMoveController;
import net.tysondperez.mcatlamod.entity.client.KeyMappings;
import net.tysondperez.mcatlamod.entity.client.MountCameraManager;
import net.tysondperez.mcatlamod.entity.client.MountControlsMessenger;
    ...
    public void tick() {
        ...
        if (flying != isFlying())
        {
            ...
            if (!level().isClientSide){
                ...
                ATLAMod.LOGGER.info("Switching Navigation to: " + (flying ? "Flying" : "Ground"));
            }
        }
...
//        }
    ...
    public void setTame(boolean pTamed) {
        ...
        ATLAMod.LOGGER.info("setTame triggered: "+pTamed);
    }
